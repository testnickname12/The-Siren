	...
	if (scr_items.length > 0) {
		for (let index = 0; index < scr_items.length; index++) {
			...
			if ((src_value > scr_item_offset - scr_item_point) && src_value < (scr_item_offset + scr_item_height)) {
				...
				if (scr_item.classList.contains('_one')) {
					continue
				}
				else {
...
let main__slider = new Swiper('.main__slider', {
	observer: true,
	observeParents: true,
	slidesPerView: 1,
	autoHeight: true,
...
let larger__first = new Swiper('.large__slider-first-container', {
	preloadImages: true,
	centeredSlides: true,
	loop: true,
	speed: 1500,
...
let articles__slider = new Swiper('.articles__slider', {
	slidesPerView: 1,
	loop: true,
	navigation: {
...
let larger__second = new Swiper('.second__slider', {
	slidesPerView: 1,
	loop: true,
	navigation: {
		nextEl: ".swiper-button-second-prev",
		prevEl: ".swiper-button-second-prev",
	},
});


let slider__names = new Swiper('.slider__names', {
	slidesPerView: 4,
	direction: 'vertical',
	watchSlidesVisibility: true,
	watchSlidesProgress: true,
	navigation: {
		nextEl: ".swiper-button-names-next",
		prevEl: ".swiper-button-names-prev",
	},
});


let slider__videos = new Swiper('.slider__videos', {
	slidesPerView: 1,
	spaceBetween: 10,
	thumbs: {
		swiper: slider__names
	}
});